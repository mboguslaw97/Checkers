...
class Board():
    def __init__(self):
        ...
        #     3, 0), (4, 1)), ((6, 1), (5, 2)), ((1, 2), (2, 3)), ((5, 2), (3, 0)), ((2, 3), (4, 1)), ((6, 3), (5, 2)), ((4, 1), (6, 3)), ((7, 4), (5, 2)), ((3, 6), (4, 7)), ((5, 2), (4, 3)), ((4, 7), (6, 5)), ((4, 3), (3, 2)), ((6, 5), (7, 6)), ((3, 0), (2, 1)), ((7, 6), (6, 5)), ((5, 4), (4, 3)), ((1, 4), (2, 3)), ((3, 2), (1, 4)), ((1, 0), (3, 2)), ((3, 2), (5, 4)), ((1, 4), (0, 3)), ((0, 7), (1, 6)), ((4, 5), (3, 4))]
        # self.load(moves)
